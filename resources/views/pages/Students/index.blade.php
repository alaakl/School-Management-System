...
{{--  <div style="background-image: url('{{ asset('assets/images/pngtree-blue-education-science-school-background-picture-image_1594576.jpg')}}')">  --}}
    @section('css')
    @toastr_css
@section('title')
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th>{{trans('Students_trans.branches')}}</th>
