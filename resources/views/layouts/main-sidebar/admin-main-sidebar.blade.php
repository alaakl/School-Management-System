<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- Branches-->
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Branches-menu">
                <div class="pull-left"><i class="fas fa-chalkboard"></i></i><span
                        class="right-nav-text">{{trans('main_trans.Branches')}}</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Branches-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{route('Branche.index')}}">{{trans('main_trans.List_Branches')}}</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Parents-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('add_parent.index')}}">{{trans('main_trans.List_Parents')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Subjects">
                <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">{{trans('main_trans.List_subject')}} </span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Subjects" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('subjects.index')}}">{{trans('main_trans.List_subject')}} </a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}">{{trans('main_trans.List_booka')}} </a> </li>
            </ul>
        </li>
        ...
        {{--  <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Onlineclasses-icon">
                <div class="pull-left"><i class="fas fa-video"></i><span class="right-nav-text">{{trans('main_trans.work_schedule')}}</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>  --}}
            {{--  {{route('online_classes.index')}}  --}}
            {{--  <ul>
                <li>
                    <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                        <li> <a href="#"> {{trans('main_trans.work_schedule')}}  </a> </li>
                        <li> <a href="#"> {{trans('main_trans.add_lecture')}}  </a> </li>
                    </ul>
                </li>
            </ul>
        </li>  --}}
