                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="table-responsive mt-15">
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                <tbody>
                                                                <?php $i = 0; ?>
                                                                @foreach ($Grade->Sections as $a)
                                                                    <tr>
                                                                        <?php $i++; ?>
                                                                        <td>{{ $i }}</td>
                                                                        <td>{{ $a->Name_Section }}</td>
                                                                        <td>{{ $a->My_classs->Name }}
                                                                        </td>
                                                                        <td>
                                                                            @if ($a->Status === 1)
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="#"
                                                                               ...
                                                                               data-toggle="modal"
                                                                               data-target="#edit{{ $a->id }}">{{ trans('Sections_trans.Edit') }}</a>
                                                                            <a href="#"
                                                                               class="btn btn-outline-danger btn-sm"
                                                                               data-toggle="modal"
                                                                               data-target="#delete{{ $a->id }}">{{ trans('Sections_trans.Delete') }}</a>
                                                                        </td>
                                                                    </tr>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       value="{{ $a->getTranslation('Name_Section', 'ar') }}">
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       value="{{ $a->getTranslation('Name_Section', 'en') }}">
                                                                                                <input id="id"
                                                                                                       type="hidden"
                                                                                                       name="id"
                                                                                                       class="form-control"
