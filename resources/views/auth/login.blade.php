...
<head>
    ...
    <title>school mangment system</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ URL::asset('assets/images/ic_school_128_28729.png') }}" type="image/x-icon" />
...
login-->
    ...
    <section class="height-100vh d-flex align-items-center page-section-ptb login"
             style="background-image: url('{{ asset('assets/images/pngtree-blue-colour-background-picture-image_1164217.jpg')}}');">
        <div class="container">
            {{--  <div class="row justify-content-center no-gutters vertical-align">
                <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                     style="background-image: url('{{ asset('assets/images/images.jpg')}}');">
                ...
                <div class="col-lg-4 col-md-6 container bg-white ">
